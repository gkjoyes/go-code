// Sample program that implements a web request with a context that is used
// to timeout the request if it takes too long.
package main
...
func main() {
	...
	// Create a context with timout of 50 milliseconds.
