// Sample test to show hwo to mock HTTP GET call internally.
...
<rss>
	<channel>
		...
		<description>Going: https://github.com/goinggo</description>
		<link>http://www.goinggo.net</link>
		<item>
			<pubDate>Sun, 15 Mar 2015 15:04:00 +0000</pubDate>
			<title>Object Oriented Programming Mechanics</title>
			<description>Go is object oriented language.</description>
...
// Channel defines the field associated with the channel tag in the buoy
// RSS document.
type Channel struct {
...
// mockServer returns a pointer to a server to handler the mock get call.
